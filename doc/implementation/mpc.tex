...
\begin{figure}
	...
	\caption{The trajectory is calculated by assuming that the aircraft will travel at a constant speed so that each point can be space by the distance the aircraft travels during one timestep.}
