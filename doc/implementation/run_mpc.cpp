...
int main(){
  ...
  int horizon_length  = 14;
  int interval_length = 5; 
  ...
  double ** result;
  result = new double*[no_intervals*interval_length];
  for(int i = 0; i<no_intervals*interval_length; i++){
  ...
  for(int i = 0 ; i < no_intervals ; i++){
      int index = findClosestPoint(X0(0),
                                   X0(1),
                                   X0(2)+X0_trim(2),
                                   X0(6)+X0_trim(6),
                                   X0(7)+X0_trim(7),
    ...
    VariablesGrid path = generateHorizon(
                                path_data,
                                timestep,
                                interval_length,
                                path_length,
