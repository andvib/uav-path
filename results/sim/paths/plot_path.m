...
grid on;
hold on;
plot(path_lin(:,2), path_lin(:,1),'LineWidth',2.0);
plot(path_cur(:,2), path_cur(:,1),'k','LineWidth',2.0);
ylabel('North [m]');
xlabel('East [m]');
ylim([0 1200]);
xlim([-300 900]);
...
grid on;
hold on;
plot(path_lin(:,2), path_lin(:,1),'k','LineWidth',2.0);
plot(pos_lin(:,2), pos_lin(:,1),'LineWidth',2.0);
ylabel('North [m]');
xlabel('East [m]');
ylim([0 1200]);
xlim([-300 900]);
...
grid on;
hold on;
plot(time_lin, phi_lin,'LineWidth',2.0);
plot(time_lin, theta_lin,'LineWidth',2.0);
plot(time_lin, psi_lin,'LineWidth',2.0);
xlim([0 110]);
ylim([-1 2.1]);
ylabel('Angle [rad]');
xlabel('Time [s]');
...
hold on;
plot(path_cur(:,2), path_cur(:,1),'k','LineWidth',2.0);
plot(pos_cur(:,2), pos_cur(:,1),'LineWidth',2.0);
ylabel('North [m]');
xlabel('East [m]');
ylim([0 1200]);
xlim([-300 900]);
...
grid on;
hold on;
plot(time_cur, phi_cur,'LineWidth',2.0);
plot(time_cur, theta_cur,'LineWidth',2.0);
plot(time_cur, psi_cur,'LineWidth',2.0);
xlim([0 110]);
ylim([-1 2.1]);
ylabel('Angle [rad]');
xlabel('Time [s]');
