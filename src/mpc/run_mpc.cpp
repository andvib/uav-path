...
int main(){
    ...
    int horizon_length = 14;    // Number of timesteps in the horizon
    int section_length = 4;    // Number of timesteps in the section
    double timestep    = 0.2;  // Duration of timestep [s]
    int no_sections    = 60;     // Number of sections to cover path
