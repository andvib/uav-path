...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[] ) 
 { 
    ...
    ocp1.subjectTo(AT_START, p_N == 0.00000000000000000000e+00);
    ocp1.subjectTo(AT_START, p_E == 0.00000000000000000000e+00);
    ocp1.subjectTo(AT_START, p_D == (-1.50000000000000000000e+02));
    ocp1.subjectTo(AT_START, q1 == 9.99700000000000030000e-01);
    ocp1.subjectTo(AT_START, q2 == 0.00000000000000000000e+00);
    ocp1.subjectTo(AT_START, q3 == 2.31999999999999980000e-02);
    ocp1.subjectTo(AT_START, q4 == -0.00000000000000000000e+00);
    ocp1.subjectTo(AT_START, u == 1.80168000000000000000e+01);
    ocp1.subjectTo(AT_START, v == 1.00000000000000000000e-04);
    ocp1.subjectTo(AT_START, w == 8.36600000000000010000e-01);
    ...
    ocp1.subjectTo(AT_START, elevator == 7.90000000000000080000e-03);
    ocp1.subjectTo(AT_START, aileron == 0.00000000000000000000e+00);
    ocp1.subjectTo(AT_START, rudder == 0.00000000000000000000e+00);
    ocp1.subjectTo(AT_START, throttle == 1.24000000000000000000e-01);
    ocp1.subjectTo(AT_END, u == 1.80168000000000000000e+01);
    ocp1.subjectTo(AT_END, p_D == (-1.50000000000000000000e+02));
    ...
    ocp1.subjectTo((-1.60000000000000000000e+02) <= p_D <= (-1.40000000000000000000e+02));
    ocp1.subjectTo(1.50000000000000000000e+01 <= u <= 2.00000000000000000000e+01);
    ocp1.subjectTo((-1.00000000000000000000e+00) <= v <= 1.00000000000000000000e+00);
    ocp1.subjectTo((-1.00000000000000000000e+00) <= w <= 1.00000000000000000000e+00);
    ocp1.subjectTo((-1.00000000000000000000e+00) <= p <= 1.00000000000000000000e+00);
    ocp1.subjectTo((-1.00000000000000000000e+00) <= q <= 1.00000000000000000000e+00);
    ocp1.subjectTo((-1.00000000000000000000e+00) <= r <= 1.00000000000000000000e+00);
    ocp1.subjectTo((-1.00000000000000000000e+00) <= elevator <= 1.00000000000000000000e+00);
    ocp1.subjectTo((-1.00000000000000000000e+00) <= aileron <= 1.00000000000000000000e+00);
    ocp1.subjectTo((-1.00000000000000000000e+00) <= rudder <= 1.00000000000000000000e+00);
    ocp1.subjectTo(0.00000000000000000000e+00 <= throttle <= 1.00000000000000000000e+00);
