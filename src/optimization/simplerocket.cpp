...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[] ) 
 { 
    ...
    ModelFcn_1X  = mxCreateDoubleMatrix( 4, 1,mxREAL );
    ModelFcn_1XA = mxCreateDoubleMatrix( 0, 1,mxREAL );
    ModelFcn_1DX = mxCreateDoubleMatrix( 4, 1,mxREAL );
    ...
    ModelFcn_1_f = mxCreateString("rocketode");
    IntermediateState setc_is_1(6);
    ...
    ocp1.subjectTo((-1.00000000000000000000e-02) <= v <= 1.30000000000000000000e+00);
