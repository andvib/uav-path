function P = computeGainsAerosonde(T_phi_delta_a, T_v_delta_r, ...
   ...
   % Calculate control gains
   P.course_kp = 0;%2*zeta_course * wn_course * P.Va / P.gravity;
   P.course_ki = 0;%wn_course^2 * P.Va / P.gravity;
   P.course_kd = 0;%0;
   ...
   % Natural frequency and damping ratio
   zeta_pitch = 0.6; % DESIGN PARAMETER
   ...
   P.heading_rudder_kd = (2*zeta_heading_rudder^2*wn_heading_rudder - a_phi1) / a_phi2;
